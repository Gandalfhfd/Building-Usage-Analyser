...
tempSuccessCheck = Import.ImportCell("Sold", sheetName, dataSheetName, exportCell, offset)
...
' Find event capacity
exportCell(1) = 33
tempSuccessCheck = Import.ImportCell("Capacity", sheetName, dataSheetName, exportCell, offset)
...
exportCell(1) = 34
offset = Array(1, 0)
tempSuccessCheck = Import.ImportCell("Blocked", sheetName, dataSheetName, exportCell, offset)
...
exportCell(1) = 44
offset = Array(0, 3)
tempSuccessCheck = Import.ImportCell("Support the Kirkgate", sheetName, dataSheetName, exportCell, offset)
...
offset = Array(1, 1)
' Find net sales
tempSuccessCheck = Import.ImportCell("Tax", sheetName, dataSheetName, exportCell, offset)
